    ...
    <form onSubmit={handleSubmit} className="space-y-8">
              ...
              />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={member.email}
                    onChange={(e) =>
                      updateGroupMember(member.id, "email", e.target.value)
                    }
                    required
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:border-[#00FFCC] focus:ring-1 focus:ring-[#00FFCC] focus:outline-none backdrop-blur-sm"
                ...
                <div>
                  ...
                  <select
                    value={member.gender}
                    onChange={(e) =>
                      updateGroupMember(member.id, "gender", e.target.value)
                    }
                    required
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white focus:border-[#00FFCC] focus:ring-1 focus:ring-[#00FFCC] focus:outline-none backdrop-blur-sm"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    value={member.dob}
                    onChange={(e) =>
                      updateGroupMember(member.id, "dob", e.target.value)
                    }
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white focus:border-[#00FFCC] focus:ring-1 focus:ring-[#00FFCC] focus:outline-none backdrop-blur-sm"
                  />
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updateGroupMember(member.id, "address", e.target.value)
                      }
                      required
                      rows={3}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        value={member.city}
                        onChange={(e) =>
                          updateGroupMember(member.id, "city", e.target.value)
                        }
                        required
                        className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:border-[#00FFCC] focus:ring-1 focus:ring-[#00FFCC] focus:outline-none backdrop-blur-sm"
                    ...
                    <div>
                      ...
                      <select
                        value={member.state}
                        onChange={(e) =>
                          updateGroupMember(member.id, "state", e.target.value)
                        }
                        required
                        className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white focus:border-[#00FFCC] focus:ring-1 focus:ring-[#00FFCC] focus:outline-none backdrop-blur-sm"
                      >
      ...
      <div className="flex justify-center pt-6">
        <button
          type="submit"
          disabled={
            isSubmitting || groupMembers.length === 0 || !groupCode.trim()
          }
      ...
      {(groupMembers.length === 0 || !groupCode.trim()) && (
        <p className="text-center text-gray-400 text-sm">
          Please enter a group code and add at least one member to submit the
          registration.
        </p>
      )}
    </form>
